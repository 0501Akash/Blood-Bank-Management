...
<body>
    <div class="a">
        ...
        <div class="d"><br><div class="d1"><a href=""><h1>Your Request</h1></a></div></div>
        <div class="e"><div class="e1">
            ...
            while($row=mysqli_fetch_array($rs))
            {
                 ...
                 <td><a href='patient request history edit.php?id=$row[id]'>Edit</a>|
                 <a href='patient request history delete.php?id=$row[id]'>Delete</a><br></td></tr>";
